...
\textbf{Applies to:} \hyperref[prob:3]{Problem 3}, \hyperref[prob:5]{Problem 5}, \hyperref[prob:8]{Problem 8}, \hyperref[prob:33]{Problem 33}
...
\textbf{Applies to:} \hyperref[prob:25]{Problem 25}, \hyperref[prob:28]{Problem 28}
...
\textbf{Applies to:} \hyperref[prob:13]{Problem 13}, \hyperref[prob:15]{Problem 15}, \hyperref[prob:45]{Problem 45a}
...
\textbf{Applies to:} \hyperref[prob:10]{Problem 10}, \hyperref[prob:18]{Problem 18}, \hyperref[prob:35]{Problem 35}, \hyperref[prob:45]{Problem 45b}
...
%-----------------------------------
\myproblem{Problem 3}\label{prob:3}
...
%-----------------------------------
\myproblem{Problem 5}\label{prob:5}
...
%-----------------------------------
\myproblem{Problem 8}\label{prob:8}
Create a Simulink model to plot the solution for $0 \le t \le 6$:
\[10\ddot{y} = 7\sin 4t + 5\cos 3t, \qquad y(0)=3,\;\dot{y}(0)=2\]

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/t6_8.png}
    \caption{Problem 8 Solution}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/t6_8_1.png}
    \caption{Problem 8 Solution Result}
\end{figure}

%-----------------------------------
\myproblem{Problem 10}\label{prob:10}
...
%-----------------------------------
\myproblem{Problem 13}\label{prob:13}
...
%-----------------------------------
\myproblem{Problem 15}\label{prob:15}
...
%-----------------------------------
\myproblem{Problem 18}\label{prob:18}
...
%-----------------------------------
\myproblem{Problem 25}\label{prob:25}
...
%-----------------------------------
\myproblem{Problem 28}\label{prob:28}
...
%-----------------------------------
\myproblem{Problem 33}\label{prob:33}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/t6_33.png}
    \caption{Problem 33 Solution}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/t6_33_2.png}
    \caption{Problem 33 Matlab function}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/t6_33_1.png}
    \caption{Problem 33 Result}
\end{figure}

%-----------------------------------
\myproblem{Problem 35}\label{prob:35}
...
%-----------------------------------
\myproblem{Problem 45}\label{prob:45}
